...
public class Suma implements Initializable {
    ...
    public void confirmarClicked(){
        ...
        Polinomio sum = pol1.sumar(pol2);
        
        System.out.println("Input: ");
        System.out.println(polInput.toStringBonito());
        System.out.println("Correcto: ");
        System.out.println(sum.toStringBonito());
        
        if(sum.comparar(polInput))
                labelRespuesta.setText("Correcto");
        else
                 labelRespuesta.setText("La respuesta correcta es " + sum.toStringBonito());
        
        System.out.println("Correcto?"+sum.comparar(polInput));
